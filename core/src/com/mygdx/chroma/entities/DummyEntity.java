...
public class DummyEntity extends Entity
{
	...
	public DummyEntity(float x, float y, float w, float h, float density, boolean dynamic, Texture img)
	{
		super();
		...
		FixtureData data = new FixtureData(Constants.DUMMY_MAIN, new TextureRegion(img), w, h);
		data.setFd(fixture);
	...
	public void update()
	{
		...
		if(Gdx.input.isKeyPressed(Keys.A))
			this.body.applyLinearImpulse(
					...
					this.body.getPosition().y+this.data.get(Constants.DUMMY_MAIN).getHeight()/2,
					true);
